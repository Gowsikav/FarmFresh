...
<head>
    <meta charset="UTF-8" />
    <title>Farm Fresh | Supplier Milk Collection</title>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav ms-auto me-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="redirectToMilkCollection?email=${dto.email}"><i
            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card shadow-sm">
                        <div class="card-header text-center" style="background: linear-gradient(90deg, #388e3c, #e8f5e9);">
                            <h3 class="mb-0">Milk Collection</h3>
                        </div>
                        <!-- Milk Collection Table -->
                        <div class="container mt-5">
                            <h3 class="mb-4">Milk Collection Records</h3>
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                <c:forEach var="record" items="${milkCollectionList}">
                                    <tr>
                                        <td>${record.collectedDate}</td>
                                        <td>${record.typeOfMilk}</td>
                                        <td>${record.price}</td>
                                        <td>${record.quantity}</td>
                                        <td>${record.totalAmount}</td>
                                    </tr>
                                </c:forEach>
                                <c:if test="${empty milkCollectionList}">
                                    <tr>
                        ...
                        <c:if test="${currentPage > 1}">
                            <a class="btn btn-outline-secondary"
                               href="redirectToMilkCollection?email=${dto.email}&page=${currentPage - 1}&size=${pageSize}">Previous</a>
                        </c:if>
                        <span> Page ${currentPage} of ${totalPages} </span>
                        <c:if test="${currentPage < totalPages}">
                            <a class="btn btn-outline-secondary"
                               href="redirectToMilkCollection?email=${dto.email}&page=${currentPage + 1}&size=${pageSize}">Next</a>
                        </c:if>
                    </div>
                </div>
            </div>
