...
<body class="d-flex flex-column min-vh-100">
    ...
    <main class="flex-grow-2 d-flex" style="margin-top: 80px; ">
        <div class="container-fluid farm-bg2 d-flex flex-column justify-content-md-start align-items-center w-100 pt-5">
           <h2 class="mb-4" style="color: #fffde7;"><i class="fa-solid fa-building-columns me-2"></i>Supplier Bank Details</h2>

  <form action="updateBankDetails" method="post"  id="bankDetailsForm" class="bg-white bg-opacity-75 p-4 rounded shadow-sm"
                style="max-width: 600px; width: 60%; color: #333;" >
    <!-- Bank Name -->
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control" id="branchName" name="bankBranch" value="${bank.bankBranch}" placeholder="Enter Branch Name">
    ...
    <div class="mb-3">
      ...
      <input type="number" class="form-control" id="accountNumber" name="accountNumber" value="${bank.accountNumber}" placeholder="Enter Account Number" required pattern="\d{9,18}">
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control" id="IFSCCode" name="IFSCCode" value="${bank.IFSCCode}" placeholder="Enter IFSC Code" required pattern="^[A-Z]{4}0[A-Z0-9]{6}$">
