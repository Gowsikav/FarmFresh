...
<head>
    <meta charset="UTF-8" />
    <title>Farm Fresh | Supplier Payment Status</title>
                                    ...
                                    <tr>
                                        ...
                                        <c:choose>
                                            <c:when test="${record.paymentStatus eq 'PENDING'}">
                                                <span style="color: red; font-weight: bold;">${record.paymentStatus}</span>
                                            </c:when>
                                            <c:when test="${record.paymentStatus eq 'PAID'}">
                                                <span style="color: green; font-weight: bold;">${record.paymentStatus}</span>
                                            </c:when>
                                            <c:otherwise>
